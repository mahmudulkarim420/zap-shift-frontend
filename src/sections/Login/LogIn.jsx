...
const LogIn = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    console.log("CLICK_TRIGGERED: Login button clicked successfully!");
    ...
    try {
      ...
      if (res?.error) {
        ...
        setLocalError("No response from auth server");
      } else {
  ...
  const handleGoogleLogin = async () => {
    console.log("CLICK_TRIGGERED: Google login button clicked successfully!");
    try {
