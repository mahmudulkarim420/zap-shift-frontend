      ...
      <DashboardLayout roleName="User">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 bg-purple-50 rounded-2xl border border-purple-100 shadow-sm transition hover:bg-purple-100 hover:scale-[1.02]">
            <h3 className="text-sm font-semibold text-purple-800 uppercase tracking-widest mb-1">
              Total Packages Sent
            </h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
              <div className="flex items-center gap-4">
                <div className="bg-primary p-3 rounded-lg text-black font-extrabold shadow-sm">
                  #102
                </div>
                <div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-medium">In Transit - Expected Today</p>
                </div>
              </div>
              <div className="text-right">
