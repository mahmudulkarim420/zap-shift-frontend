  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-[#E5E7EB] shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)]">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-end
                      justify-between gap-6 sm:gap-8 lg:gap-12
                      px-4 sm:px-10 lg:px-16
                      pt-16 sm:pt-28 lg:pt-28
        ...
        <div className="text-white max-w-xl w-full text-center lg:text-left pb-0 lg:pb-14">
          ...
          {/* Eyebrow */}
          <p className="text-xs sm:text-sm font-semibold tracking-wider text-primary mb-2 sm:mb-3">
            Our Commitment
          </p>

          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold leading-snug mb-3 sm:mb-5">
            Merchant & customer satisfaction{' '}
            <span className="text-primary">is our first priority</span>
          </h2>

          <p className="text-white/70 text-xs sm:text-base leading-relaxed mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0">
          ...
          {/* Stats row */}
          <div className="grid grid-cols-3 sm:flex justify-center lg:justify-start gap-3 sm:gap-8 mb-6 sm:mb-10">
            {stats.map((stat) => {
              const Icon = stat.icon;
              return (
                <div key={stat.label} className="text-center lg:text-left bg-white/5 sm:bg-transparent rounded-xl p-2 sm:p-0 border border-white/5 sm:border-0">
                  <div className="flex items-center justify-center lg:justify-start gap-1 sm:gap-1.5 mb-0.5 sm:mb-1">
                    <Icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary/70" />
                    <p className="text-base sm:text-2xl font-bold text-primary leading-none">
                      {stat.value}
                    </p>
                  </div>
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-2.5 sm:gap-4">
            ...
            <button className="border border-white/15 bg-white/10 text-white font-semibold
                               px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-xs sm:text-sm
        ...
        {/* Right — Image */}
        <div className="shrink-0 flex justify-center lg:justify-end w-full lg:w-auto mt-2 sm:mt-0">
          <Image
            src={boxImg}
            alt="Merchant delivery illustration"
            width={480}
            height={380}
            className="w-56 sm:w-80 lg:w-[420px] xl:w-[480px] object-contain drop-shadow-2xl"
            priority
          />
        </div>
      </div>
